...
BlockHero.prototype = {
    ...
    initLettering: function() {
        -1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") ? ($("#welcome", $lettering).fadeOut(),
        $("#welcome-shadow", $lettering).fadeOut()) : ($("#welcome-underline, #welcome-underline-shadow", $lettering).velocity({
...
BlockWork.prototype = {
    ...
    initListener: function() {
        $(document).on("click", "a[data-next-project]", this.onNextProjectTriggerClicked.bind(this)),
        $("a[data-project]").on("click", this.onProjectTriggerClicked),
        $("a.chapter__close-button").on("click", this.onChapterCloseClicked.bind(this)),
    ...
    openProject: function(e, t) {
        ...
        setTimeout(function() {
            var o = 0;
            Math.floor($(window).scrollTop()) != Math.floor(e.offset().top) && (o = Math.min(1200, Math.max(600, Math.abs($(window).scrollTop() - e.offset().top) / $(window).height() * 600)),
            console.info(o),
            $("html,body").animate({
            ...
            setTimeout(function() {
                ...
                $(window).scrollTop($(".chapter__content", $block).offset().top),
    ...
    closeProject: function(e, t) {
        ...
        var o = 0;
        return $(window).scrollTop() != e.offset().top && (o = Math.min(1200, Math.max(600, ($(window).scrollTop() - e.offset().top) / $(window).height() * 600)),
        $("html,body").animate({
            scrollTop: e.offset().top
        }, o, "easeInOutQuart")),
        setTimeout(function() {
        ...
        setTimeout(function() {
            ...
            t && ($(".project-nav a", $block).removeClass("selected"),
    ...
    onProjectTriggerClicked: function() {
        ...
        $('.project-nav a[data-project="' + $(this).data("project") + '"]', $block).addClass("selected");
        var e = $('.project[data-project="' + $(this).data("project") + '"]')
          , t = $(this).attr("href");
        return e.is($currentProject) || (that.openProject(e, t),
        Main.trackPage(t)),
        !1
    },
    onNextProjectTriggerClicked: function() {
        ...
        var t = $projects.eq(e);
        return $('.project-nav a[data-project="' + t.data("project") + '"]', $block).trigger("click"),
        !1
    },
    ...
    onChapterCloseClicked: function() {
        return this.closeProject($currentProject, !0),
        !1
    },
    init: function() {
        this.initPlugins(),
...
SiteFooter.prototype = {
    ...
    onWindowScroll: function() {
        ...
        e > .25 && !this.isDrawn && (this.drawLettering(),
        this.isDrawn = !0),
...
Overlay.prototype = {
    ...
    onOverlayTrigger: function() {
        return $('a[data-overlay="' + $(this).data("overlay") + '"]').toggleClass("overlay--triggered"),
        $('.overlay[data-overlay="' + $(this).data("overlay") + '"]').toggleClass("overlay--visible"),
        !1
    }
},
Fullpage.prototype = {
...
Main.prototype = {
    ...
    trackPage: function(e) {
        ...
        "undefined" != typeof window._gaq && window._gaq.push(["_trackPageview", e]),
